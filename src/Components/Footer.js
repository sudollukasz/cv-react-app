          ...
          <Grid>
            <Grid.Row columns={7}>
              <Grid.Column verticalAlign="middle">
                <Image src={EthLogo} size="tiny" verticalAlign="bottom" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={TruffleLogo} size="tiny" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={InfuraLogo} size="tiny" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={NodejsLogo} size="tiny" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={ReactLogo} size="tiny" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={ReduxLogo} size="tiny" />
              </Grid.Column>
              <Grid.Column verticalAlign="middle">
                <Image src={SemanticLogo} size="tiny" />
              </Grid.Column>
            </Grid.Row>
          </Grid>
        </Segment>
