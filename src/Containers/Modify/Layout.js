...
class Layout extends Component {
    componentWillMount() {
        if (!this.props.contract.owner) { this.getData() }      
    }
    ...
    return (
        <div>
            <List>
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <EditPersonal change={this.handleChange} submit={this.handleSubmit} /> : <h2><center>Only owner can modify smart contract</center></h2>}
                    </List.Content>
                </List.Item>
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <AddWork change={this.handleChange} submit={this.handleSubmit} /> : ''}
                    </List.Content>
                </List.Item>  
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <AddSchool change={this.handleChange} submit={this.handleSubmit} /> : ''}
                    </List.Content>
                </List.Item>
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <AddCert change={this.handleChange} submit={this.handleSubmit} /> : ''}
                    </List.Content>
                </List.Item> 
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <AddLang change={this.handleChange} submit={this.handleSubmit} /> : ''}
                    </List.Content>
                </List.Item> 
                <List.Item>
                    <List.Content>
                        {this.props.contract.owner ? <AddInterest change={this.handleChange} submit={this.handleSubmit} /> : ''}
                    </List.Content>
                </List.Item>  
            </List>            
